...
const Transactions = () => {
  ...
  const { subscription, getSubscriptionDetail } = useContext(PaymentContext);
  ...
  return (
      <div className="flex w-full justify-center items-center 2xl:px-40 gradient-bg-transactions">
